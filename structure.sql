para la primera vez agregar:
/*
DROP DATABASE IF EXISTS dietetica_db; (como se llame la base)
...
--
-- Host: 127.0.0.1    Database: dietetica_db
-- ------------------------------------------------------
...
INSERT INTO `categories` VALUES (1,'Suplementos Deportivos'),(2,'Suplementos Naturales'),(3,'Cosmética y Salud'),(4,'Alimentos Nutricionales'),(5,'Bebidas e Infusiones'),(6,'Despensa');
...
CREATE TABLE `products` (
  ...
  CONSTRAINT `products_ibfk_1` FOREIGN KEY (`status_id`) REFERENCES `status` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `status` VALUES (1,'Oferta'),(2,'Destacado');
...
-- Dump completed on 2024-02-20 23:08:28
